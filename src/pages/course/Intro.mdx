...
<img className="fill" src="img/gandalf.jpg" alt="gandalf" />
...
<img className="fill" src="img/bg3.jpg" alt="bg3" />

## 2, Weboldalakat fejleszteni

<img className="fill" src="img/facebook.png" alt="fb" />

## Robotokat irányítani

<img className="fill" src="img/apollo15.jpg" alt="apollo15" />

## 3, Zenét, videókat szerkeszteni

<img className="fill" src="img/sphere.png" alt="sphere" />
...
<img className="fill" src="img/step.jpg" alt="step" />
...
<img className="fill" src="img/instuction.png" alt="instuction" />
...
<img className="fill" src="img/work.png" alt="work" />
...
<img className="fill" src="img/computer_problems.png" alt="computer_problems" />
...
<img className="fill" src="img/mario.jpg" alt="mario" />
...
<img className="fill" src="img/python2.png" alt="python2" />
...
<img className="fill" src="img/choccoveredcherries.jpg" alt="choccoveredcherries" />
...
<img className="fill" src="img/flowchart.png" alt="Folyamatábra" />
...
Előre tudjuk hányszor szeretnénk ismételni vagyis hányszor szeretnénk lépi (**for** _each_ step)
...
Addig ismételjük **amíg** a feltétel igaz (**while** it is _true_)
